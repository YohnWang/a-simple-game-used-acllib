...
extern "C" {
	...
	/*windows*/
	extern int getWndXpos();
	extern int getWndYpos();

	/*picture*/
	extern void drawPicture(ACL_Image *pic,int x,int y);
	extern void drawPictureScale(ACL_Image *pic,int x,int y,int width,int height);
